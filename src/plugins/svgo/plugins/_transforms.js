 ...
 */
export const transform2js = function(transformString) {
 ...
 */
export const transformsMultiply = function(transforms) {
 ...
 */
export const matrixToTransform = function(transform, params) {
 ...
 */
export const transformArc = function(arc, transform) {
  var a = arc[0],
    b = arc[1],
