import csso from 'csso/lib/index'

export const type = 'full'

export const active = true

export const description = 'minifies styles and removes unused styles based on usage data'
 ...
 */
export const fn = function(ast, options) {
  options = options || {}
