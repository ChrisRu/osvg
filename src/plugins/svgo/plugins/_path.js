...
var regPathInstructions = /([MmLlHhVvCcSsQqTtAaZz])\s*/,
  ...
  cleanupOutData = require('../lib/tools').cleanupOutData,
  removeLeadingZero = require('../lib/tools').removeLeadingZero,
  prevCtrlPoint
 ...
 */
export const relative2absolute = function(data) {
 ...
 */
export const applyTransforms = function(elem, path, params) {
 ...
 * @return {Object}
 */
export const computeCubicBoundingBox = function(xa, ya, xb, yb, xc, yc, xd, yd) {
 ...
 * @return {Object}
 */
export const computeQuadraticBoundingBox = function(xa, ya, xb, yb, xc, yc) {
  var minx = Number.POSITIVE_INFINITY,
    miny = Number.POSITIVE_INFINITY,
    maxx = Number.NEGATIVE_INFINITY,
    maxy = Number.NEGATIVE_INFINITY,
